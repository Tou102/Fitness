    ...
    import BmiScreen
    import CaloriesRecord
    import CaloriesScreen
    import CaloriesStatisticsScreen
    ...
    fun AppNavigation(
        ...
        NavHost(
            ...
            // Đã sửa trùng, bỏ route calories_stats ở đây

            composable("chaybo") {
                RunningTrackerScreen(
                    onNavigateToSave = { distance, time, calories ->
                        navController.navigate("calo")
                    }
                )
            }
